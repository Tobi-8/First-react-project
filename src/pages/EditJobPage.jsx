...
toast.success('job edited succefully')
navigate(`/jobs/${id}`);
  ...
  return (
     <section className="bg-blue-100 sm:px-20 p-8 sm:py-20 ">
       <div className="px-4 py-4 mx-auto w-full md:max-w-200 sm:max-w-150">
...
<h1 className="text-center p-2 mt-7 sm:text-4xl text-3xl font-bold">Update Job</h1>
...
<div className="flex flex-col gap-2">
  ...
  <input type="tel" placeholder="Optional Phone for Applicants"
...
<button className="text-center bg-indigo-500 text-white block w-full py-2 font-bold text-lg rounded-3xl mt-4 mb-9">Update Job</button>
</form>
</div>
    </section>
